<nav x-data="{ isOpen: false }" class="fixed top-0 left-0 w-full bg-zinc-800 shadow z-[50]">
    <div class="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
        ...
        <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-zinc-800 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center">
