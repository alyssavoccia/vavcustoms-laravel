                ...
                <div x-on:click.away="showCart = false" class="pointer-events-auto w-screen max-w-md">
                    <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                        ...
                        <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                            ...
                            <div class="mt-6">
                                <button wire:click="checkout" type="button" class="w-full flex items-center justify-center rounded-md border border-transparent bg-zinc-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-zinc-700">Checkout</button>
                            </div>
